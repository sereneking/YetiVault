...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/IDRotF/Spitting%20Mimic.webp#token)
...
***Adhesive (Object Form Only).*** The mimic adheres to anything that touches it. A Huge or smaller creature adhered to the mimic is also [grappled](/Systems/5e/rules/conditions.md#grappled) by it (escape DC 16). Ability checks made to escape this grapple have disadvantage.
