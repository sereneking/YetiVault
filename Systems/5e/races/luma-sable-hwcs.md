...
Your innate eccentricities make it hard for other folk to figure you out. When someone performs a Wisdom ([Insight](/Systems/5e/rules/skills.md#Insight)) check against you, they have disadvantage on their roll. Additionally, you gain advantage on Charisma ([Deception](/Systems/5e/rules/skills.md#Deception)) checks made against creatures that are not lumas.
