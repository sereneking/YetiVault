...
```ad-statblock
title: Elder Dinosaur (Zacama, Primal Calamity)
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/PSX/Elder%20Dinosaur%20%28Zacama%2C%20Primal%20Calamity%29.webp#token)
...
***Multiattack.*** The elder dinosaur can use its Frightful Presence. It then makes five attacks: three with its bite, one with its stomp, and one with its tail ^[***Note:** This statblock does not have these actions available.*]. It can use its Swallow instead of a bite.

***Bite.*** *Melee Weapon Attack:* `+19` to hit, reach 10 ft., one target. *Hit:* 36 (`4d12 + 10`) piercing damage. If the target is a creature, it is [grappled](/Systems/5e/rules/conditions.md#grappled) (escape DC 20). Until this grapple ends, the target is [restrained](/Systems/5e/rules/conditions.md#restrained). If the elder dinosaur has three targets [restrained](/Systems/5e/rules/conditions.md#restrained) in this way, it can't bite another target.
