...
***Overbearing Pack.*** The xvart has advantage on Strength ([Athletics](/Systems/5e/rules/skills.md#Athletics)) checks to shove a creature if at least one of the xvart's allies is within 5 feet of the target and the ally isn't [incapacitated](/Systems/5e/rules/conditions.md#incapacitated).
