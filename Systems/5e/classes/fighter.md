...
- (a) [chain mail](/Systems/5e/items/chain-mail.md) or (b) [leather armor](/Systems/5e/items/leather-armor.md), [longbow](/Systems/5e/items/longbow.md), and [20 arrows](/Systems/5e/items/arrows-20.md)  
- (a) a martial weapon and a [shield](/Systems/5e/items/shield.md) or (b) two martial weapons  
- (a) a [light crossbow](/Systems/5e/items/light-crossbow.md) and [20 bolts](/Systems/5e/items/crossbow-bolts-20.md) or (b) two [handaxes](/Systems/5e/items/handaxe.md)  
...
*4th-level fighter [optional class features](/Systems/5e/rules/variant-rules/optional-class-features-tce.md)*

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can do one of the following, as you shift the focus of your martial practice:

- Replace a [fighting style](/Systems/5e/optional-features/list-fighting-style-fighter.md) you know with another fighting style available to fighters.  
- If you know any [maneuvers](/Systems/5e/optional-features/list-maneuver-battle-master.md) from the [Battle Master](/Systems/5e/classes/fighter-battle-master.md) archetype, you can replace one maneuver you know with a different maneuver.  
...
At 11th level, you can attack three times whenever you take the [Attack](/Systems/5e/rules/actions.md#Attack) action on your turn.
...
At 20th level, you can attack four times whenever you take the [Attack](/Systems/5e/rules/actions.md#Attack) action on your turn.
