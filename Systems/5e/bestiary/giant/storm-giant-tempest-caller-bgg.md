...
***Scrying (Requires Storm Rune).*** The giant can use its crystal ball to cast the [scrying](/Systems/5e/spells/scrying.md) spell (save DC 17).
...
**1/day each**: [control water](/Systems/5e/spells/control-water.md), [control weather](/Systems/5e/spells/control-weather.md) (as an action), [dispel magic](/Systems/5e/spells/dispel-magic.md), [plane shift](/Systems/5e/spells/plane-shift.md), [sending](/Systems/5e/spells/sending.md), [time stop](/Systems/5e/spells/time-stop.md)
