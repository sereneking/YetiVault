...
```ad-statblock
title: Aarakocra Spelljammer
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/LoX/Aarakocra%20Spelljammer.webp#token)
...
***Spellcasting.*** The aarakocra is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, `+6` to hit with spell attacks). The aarakocra has the following wizard spells prepared:
