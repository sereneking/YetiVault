...
```ad-statblock
title: Warrior
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/DC/Warrior.webp#token)
*Medium humanoid, Unaligned*

- **Armor Class** 21 ([plate](/Systems/5e/items/plate-armor.md), [shield](/Systems/5e/items/shield.md))
