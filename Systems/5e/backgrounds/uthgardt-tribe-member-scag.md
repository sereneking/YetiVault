...
- **Equipment.** A [hunting trap](/Systems/5e/items/hunting-trap.md), a totemic token or set of tattoos marking your loyalty to Uthgar and your tribal totem, a set of [traveler's clothes](/Systems/5e/items/travelers-clothes.md), and a [pouch](/Systems/5e/items/pouch.md) containing 10 gp  
...
Use the tables for the [outlander](/Systems/5e/backgrounds/outlander.md) background in the Player's Handbook as the basis for your traits and motivations, modifying the entries when appropriate to suit your identity as a member of an Uthgardt tribe.
