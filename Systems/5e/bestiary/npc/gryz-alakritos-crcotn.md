...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CRCotN/Gryz%20Alakritos.webp#token)
*Small or Medium humanoid (goblin, wizard), Neutral Good*
...
***Spellcasting.*** Gryz casts one of the following spells, requiring no material components and using Intelligence as the spellcasting ability (spell save DC 15):
...
***Multiattack.*** Gryz makes two Arcane Shock or Dagger of the Poisoned Mind attacks.
