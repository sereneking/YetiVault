...
aliases: ["Elder Dinosaur (Tetzimoc, Primal Death)"]
---
...
```ad-statblock
title: Elder Dinosaur (Tetzimoc, Primal Death)
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/PSX/Elder%20Dinosaur%20%28Tetzimoc%2C%20Primal%20Death%29.webp#token)
...
***Tail.*** *Melee Weapon Attack:* `+19` to hit, reach 20 ft., one target. *Hit:* 24 (`4d6 + 10`) piercing damage. If the target is a creature, it must succeed on a DC 20 Strength saving throw or be knocked [prone](/Systems/5e/rules/conditions.md#prone).
