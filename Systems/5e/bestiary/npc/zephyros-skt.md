...
```ad-statblock
title: Zephyros
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Zephyros.webp#token)
...
***Keen Smell.*** Zephyros has advantage on Wisdom ([Perception](/Systems/5e/rules/skills.md#Perception)) checks that rely on smell.
...
**At will**: [message](/Systems/5e/spells/message.md), [prestidigitation](/Systems/5e/spells/prestidigitation.md), [ray of frost](/Systems/5e/spells/ray-of-frost.md)

**1/day each**: [cone of cold](/Systems/5e/spells/cone-of-cold.md), [contact other plane](/Systems/5e/spells/contact-other-plane.md) (cast as 1 action), [greater invisibility](/Systems/5e/spells/greater-invisibility.md), [mass suggestion](/Systems/5e/spells/mass-suggestion.md), [nondetection](/Systems/5e/spells/nondetection.md), [Otiluke's resilient sphere](/Systems/5e/spells/otilukes-resilient-sphere.md), [protection from energy](/Systems/5e/spells/protection-from-energy.md), [tongues](/Systems/5e/spells/tongues.md)

**2/day each**: [gust of wind](/Systems/5e/spells/gust-of-wind.md), [levitate](/Systems/5e/spells/levitate.md), [magic missile](/Systems/5e/spells/magic-missile.md)

## Actions

***Fling.*** Zephyros tries to throw a Small or Medium creature within 10 feet of it. The target must succeed on a DC 20 Dexterity saving throw or be hurled up to 60 feet horizontally in a direction of Zephyros's choice and land [prone](/Systems/5e/rules/conditions.md#prone), taking `1d8` bludgeoning damage for every 10 feet it was thrown.

***Wind Aura.*** A magical aura of wind surrounds Zephyros. The aura is a 10-foot-radius sphere that lasts as long as he maintains [concentration](/Systems/5e/rules/conditions.md#concentration) on it (as if concentrating on a spell). While the aura is in effect, Zephyros gains a +2 bonus to his AC against ranged weapon attacks, and all open flames within the aura are extinguished unless they are magical.
