...
```ad-statblock
title: Chishinix
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/PaBTSO/Chishinix.webp#token)
...
***Severed Head.*** Chishinix is always accompanied by a [severed head](/Systems/5e/bestiary/npc/chishinix-head-pabtso.md).
