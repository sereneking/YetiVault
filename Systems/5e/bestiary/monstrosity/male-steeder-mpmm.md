...
***Sticky Leg.*** *Melee Weapon Attack:* `+4` to hit, reach 5 ft., one Small or Tiny creature. *Hit:* The target is stuck to the steeder's leg and [grappled](/Systems/5e/rules/conditions.md#grappled) (escape DC 12). The steeder can have only one creature [grappled](/Systems/5e/rules/conditions.md#grappled) at a time.
```
^statblock
