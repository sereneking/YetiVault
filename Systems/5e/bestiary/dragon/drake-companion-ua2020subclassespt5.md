...
tags:
- compendium/src/5e/ua2020subclassespt5
- monster/cr/
- monster/size/small
- monster/type/dragon
...
---
# Drake Companion
*Source: UA2020SubclassesPt5 p. 3*  

```ad-statblock
title: Drake Companion
![](https://raw.githubusercontent.com/TheGiddyLimit/unearthed-arcana/master/_img/UA2020SubclassesPt5/tokens/Drake%20Companion.webp#token)
...
***Bite.*** *Melee Weapon Attack:* `3 + PB` to hit, reach 5 ft., one target. *Hit:* `1d6` piercing damage plus `PB` damage of a type determined by the drake's Draconic Essence.
