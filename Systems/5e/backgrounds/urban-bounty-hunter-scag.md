...
- **Skill Proficiencies.** Choose two from among [Deception](/Systems/5e/rules/skills.md#Deception), [Insight](/Systems/5e/rules/skills.md#Insight), [Persuasion](/Systems/5e/rules/skills.md#Persuasion), and [Stealth](/Systems/5e/rules/skills.md#Stealth)  
- **Tool Proficiencies.** Choose two from among one type of gaming set, one musical instrument, and [thieves' tools](/Systems/5e/items/thieves-tools.md)  
- **Equipment.** A set of clothes appropriate to your duties and a [pouch](/Systems/5e/items/pouch.md) containing 20 gp  
...
Use the tables for the [criminal](/Systems/5e/backgrounds/criminal.md) background in the Player's Handbook as the basis for your bounty hunter's traits and motivations, modifying the entries when appropriate to suit your identity as a bounty hunter.
