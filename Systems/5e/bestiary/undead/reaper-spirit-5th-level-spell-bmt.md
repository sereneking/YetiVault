...
- monster/size/medium
- monster/type/undead
aliases: ["Reaper Spirit (5th-level Spell)"]
---
# Reaper Spirit (5th-level Spell)
*Source: The Book of Many Things p. 50*  

```ad-statblock
title: Reaper Spirit (5th-level Spell)
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/BMT/Reaper%20Spirit.webp#token)
