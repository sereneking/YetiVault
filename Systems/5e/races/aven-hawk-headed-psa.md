...
- race/aven/hawk-headed
aliases: ["Aven (Hawk-Headed)"]
---
# Aven (Hawk-Headed)
...
Following the example of Oketra, hawk-headed aven often focus on the techniques of long-range combat. Most prefer [javelins](/Systems/5e/items/javelin.md), but some are skilled with bows, [spears](/Systems/5e/items/spear.md), and [throwing axes](/Systems/5e/items/handaxe.md).
