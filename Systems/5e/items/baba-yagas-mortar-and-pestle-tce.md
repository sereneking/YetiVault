...
You can also use the artifact as [alchemist's supplies](/Systems/5e/items/alchemists-supplies.md), [brewer's supplies](/Systems/5e/items/brewers-supplies.md), [cook's utensils](/Systems/5e/items/cooks-utensils.md), an [herbalism kit](/Systems/5e/items/herbalism-kit.md), and a [poisoner's kit](/Systems/5e/items/poisoners-kit.md). You have advantage on any check you make using the artifact as one of these tools.
