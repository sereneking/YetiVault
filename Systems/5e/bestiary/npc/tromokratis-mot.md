...
```ad-statblock
title: Tromokratis
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/MOT/Tromokratis.webp#token)
...
- **Condition Immunities** [charmed](/Systems/5e/rules/conditions.md#charmed), [frightened](/Systems/5e/rules/conditions.md#frightened), [paralyzed](/Systems/5e/rules/conditions.md#paralyzed), [restrained](/Systems/5e/rules/conditions.md#restrained)
- **Languages** —
- **Challenge** 26
...
***Pincer.*** *Melee Weapon Attack:* `+18` to hit, reach 20 ft., one target. *Hit:* 20 (`3d6 + 10`) bludgeoning damage, and if the target is a creature, it is [grappled](/Systems/5e/rules/conditions.md#grappled) (escape DC 26). Until the grapple ends, the target is [restrained](/Systems/5e/rules/conditions.md#restrained), and Tromokratis can't use this attack on anyone else.

***Tail.*** *Melee Weapon Attack:* `+18` to hit, reach 20 ft., one target. *Hit:* 23 (`3d8 + 10`) bludgeoning damage, and if the target is a creature, it is knocked [prone](/Systems/5e/rules/conditions.md#prone).

***Tentacle Grasp.*** *Melee Weapon Attack:* `+18` to hit, reach 20 ft., one creature. *Hit:* 20 (`3d6 + 10`) bludgeoning damage, and the target is [grappled](/Systems/5e/rules/conditions.md#grappled) (escape DC 26). If the target doesn't escape by the end of its next turn, Tromokratis throws the target up to 60 feet in a straight line. The target lands [prone](/Systems/5e/rules/conditions.md#prone) and takes 21 (`6d6`) bludgeoning damage.

***Bite.*** *Melee Weapon Attack:* `+18` to hit, reach 5 ft., one target. *Hit:* 29 (`3d12 + 10`) piercing damage. If the target is a Large or smaller creature [grappled](/Systems/5e/rules/conditions.md#grappled) by Tromokratis, that creature is swallowed, and the grapple ends. While swallowed, the creature is [blinded](/Systems/5e/rules/conditions.md#blinded) and [restrained](/Systems/5e/rules/conditions.md#restrained), it has total cover against attacks and other effects outside Tromokratis, and it takes 42 (`12d6`) acid damage at the start of each of Tromokratis's turns. If Tromokratis takes 50 damage or more on a single turn from a creature inside it, Tromokratis must succeed on a DC 20 Constitution saving throw at the end of that turn or regurgitate all swallowed creatures, which fall [prone](/Systems/5e/rules/conditions.md#prone) in a space within 10 feet of Tromokratis. If Tromokratis dies, a swallowed creature is no longer [restrained](/Systems/5e/rules/conditions.md#restrained) by it and can escape from the corpse by using 15 feet of movement, exiting [prone](/Systems/5e/rules/conditions.md#prone).
...
![Tromokratis](/Systems/5e/bestiary/legendary-group/tromokratis-mot.md)
```
^statblock