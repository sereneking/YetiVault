...
While holding the deck, you can use an action to cast one of the following spells (save DC 18) from it: [comprehend languages](/Systems/5e/spells/comprehend-languages.md), [detect evil and good](/Systems/5e/spells/detect-evil-and-good.md), [detect magic](/Systems/5e/spells/detect-magic.md), [detect poison and disease](/Systems/5e/spells/detect-poison-and-disease.md), [locate object](/Systems/5e/spells/locate-object.md), or [scrying](/Systems/5e/spells/scrying.md). Once you use the deck to cast a spell, you can't cast that spell again from it until the next dawn.

## Enduring Vision

While holding the deck, you automatically succeed on Constitution saving throws made to maintain your [concentration](/Systems/5e/rules/conditions.md#concentration) on divination spells.
...
| dice: d100 | Card | Soul |
|------------|------|------|
| 1 | Artifact | [Flameskull](/Systems/5e/bestiary/undead/flameskull.md) |
| 2 | Beast | [Wraith](/Systems/5e/bestiary/undead/wraith.md) |
| 3 | Broken | [Banshee](/Systems/5e/bestiary/undead/banshee.md) |
| 4 | Darklord | [Vampire](/Systems/5e/bestiary/undead/vampire.md) |
| 5 | Donjon | [Mummy](/Systems/5e/bestiary/undead/mummy.md) |
| 6 | Executioner | [Death knight](/Systems/5e/bestiary/undead/death-knight.md) |
| 7 | Ghost | [Ghost](/Systems/5e/bestiary/undead/ghost.md) |
| 8 | Horseman | [Mummy lord](/Systems/5e/bestiary/undead/mummy-lord.md) |
| 9 | Innocent | [Ghost](/Systems/5e/bestiary/undead/ghost.md) |
| 10 | Marionette | [Mummy](/Systems/5e/bestiary/undead/mummy.md) |
| 11 | Mists | [Wraith](/Systems/5e/bestiary/undead/wraith.md) |
| 12 | Raven | [Vampire spawn](/Systems/5e/bestiary/undead/vampire-spawn.md) |
| 13 | Seer | [Vampire](/Systems/5e/bestiary/undead/vampire.md) |
| 14 | Tempter | [Vampire spawn](/Systems/5e/bestiary/undead/vampire-spawn.md) |
| 15-100 | — | — |
^souls-of-the-tarokka
...
Luba's Tarokka of Souls can be destroyed only if all fourteen souls within are released and destroyed. This reveals a fifteenth soul, a [lich](/Systems/5e/bestiary/undead/lich.md), that inhabits the Nether card, which appears only when the fourteen souls are defeated. If this ancient entity is destroyed, the Nether card vanishes and the deck becomes a normal [tarokka deck](/Systems/5e/decks/tarokka-deck-cos.md), with no special properties, but it includes a new card of the DM's design.
