...
```ad-statblock
title: Rahadin
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/CoS/Rahadin.webp#token)
...
***Deathly Choir.*** Any creature within 10 feet of Rahadin that isn't protected by a [mind blank](/Systems/5e/spells/mind-blank.md) spell hears in its mind the screams of the thousands of people Rahadin has killed. As a bonus action, Rahadin can force all creatures that can hear the screams to make a DC 16 Wisdom saving throw. Each creature takes 16 (`3d10`) psychic damage on a failed save, or half as much damage on a successful one.

***Fey Ancestry.*** Rahadin has advantage on saving throws against being [charmed](/Systems/5e/rules/conditions.md#charmed), and magic can't put him to sleep.
...
**1/day**: [magic weapon](/Systems/5e/spells/magic-weapon.md), [nondetection](/Systems/5e/spells/nondetection.md)

**3/day**: [misty step](/Systems/5e/spells/misty-step.md), [phantom steed](/Systems/5e/spells/phantom-steed.md)

## Actions

***Multiattack.*** Rahadin attacks three times with his scimitar, or twice with his [poisoned](/Systems/5e/rules/conditions.md#poisoned) darts.
