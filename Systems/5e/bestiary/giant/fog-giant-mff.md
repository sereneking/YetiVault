...
```ad-statblock
title: Fog Giant
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/MFF/Fog%20Giant.webp#token)
...
***Denizen of the Mist.*** During its turn, the fog giant ignores the effects of [fog cloud](/Systems/5e/spells/fog-cloud.md) spells cast by it or other allied fog giants.
...
**3/day each**: [feather fall](/Systems/5e/spells/feather-fall.md), [misty step](/Systems/5e/spells/misty-step.md)

## Actions

***Multiattack.*** The giant makes two greatsword attacks and casts [fog cloud](/Systems/5e/spells/fog-cloud.md).
