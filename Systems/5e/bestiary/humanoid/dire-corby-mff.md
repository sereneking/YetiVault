...
```ad-statblock
title: Dire Corby
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/MFF/Dire%20Corby.webp#token)
...
***Keen Hearing.*** The dire corby has advantage on Wisdom ([Perception](/Systems/5e/rules/skills.md#Perception)) checks that rely on hearing.
