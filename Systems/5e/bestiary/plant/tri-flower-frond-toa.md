...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/ToA/Tri-flower%20Frond.webp#token)
...
***Orange Blossom.*** The tri-flower frond chooses one creature it can see within 5 feet of it. The target must succeed on a DC 11 Constitution saving throw or be [poisoned](/Systems/5e/rules/conditions.md#poisoned) for 1 hour. While [poisoned](/Systems/5e/rules/conditions.md#poisoned) in this way, the target is [unconscious](/Systems/5e/rules/conditions.md#unconscious). At the end of each minute, the [poisoned](/Systems/5e/rules/conditions.md#poisoned) target can repeat the saving throw, ending the effect on itself on a success.
