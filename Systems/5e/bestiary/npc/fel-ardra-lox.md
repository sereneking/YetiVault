...
```ad-statblock
title: Fel Ardra
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/LoX/Fel%20Ardra.webp#token)
...
***Dark Devotion.*** Fel has advantage on saving throws against being [charmed](/Systems/5e/rules/conditions.md#charmed) or [frightened](/Systems/5e/rules/conditions.md#frightened).

***Spellcasting.*** Fel is a 4th-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 11, `+3` to hit with spell attacks). Fel has the following cleric spells prepared:
...
***Multiattack.*** Fel makes two melee attacks.
