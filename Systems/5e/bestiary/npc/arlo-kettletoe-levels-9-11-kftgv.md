...
```ad-statblock
title: Arlo Kettletoe (Levels 9-11)
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/KftGV/Arlo%20Kettletoe%20%28Levels%209-11%29.webp#token)
...
***Spellcasting.*** Arlo Kettletoe is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, `+6` to hit with spell attacks). Arlo Kettletoe has the following wizard spells prepared:
