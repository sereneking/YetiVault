...
```ad-statblock
title: Topolah
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/LoX/Topolah.webp#token)
...
***Spellcasting.*** Topolah is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, `+6` to hit with spell attacks). Topolah has the following wizard spells prepared:
