...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/OotA/Zilchyn%20Q%27Leptin.webp#token)
...
***Fey Ancestry.*** Zilchyn has advantage on saving throws against being [charmed](/Systems/5e/rules/conditions.md#charmed), and magic can't put Zilchyn to sleep.

***Sunlight Sensitivity.*** While in sunlight, Zilchyn has disadvantage on attack rolls, as well as on Wisdom ([Perception](/Systems/5e/rules/skills.md#Perception)) checks that rely on sight.
