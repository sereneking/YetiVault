...
***Antimagic Susceptibility.*** The hut is [incapacitated](/Systems/5e/rules/conditions.md#incapacitated) while the magic gem that animates it is in the area of an [antimagic field](/Systems/5e/spells/antimagic-field.md). If targeted by [dispel magic](/Systems/5e/spells/dispel-magic.md), the hut must succeed on a Constitution saving throw against the caster's spell save DC or fall [unconscious](/Systems/5e/rules/conditions.md#unconscious) for 1 minute.
