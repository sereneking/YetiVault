...
aliases: ["Elder Monastery of the Distressed Body Monk"]
---
# Elder Monastery of the Distressed Body Monk
*Source: Lost Laboratory of Kwalish p. 12*  

```ad-statblock
title: Elder Monastery of the Distressed Body Monk
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/LLK/Elder%20Monastery%20of%20the%20Distressed%20Body%20Monk.webp#token)
...
***Dark Devotion.*** The monk has advantage on saving throws against being [charmed](/Systems/5e/rules/conditions.md#charmed) or [frightened](/Systems/5e/rules/conditions.md#frightened).

***Spellcasting.*** The monk is a 4th-level spellcaster. Its spellcasting ability is Wisdom (spell save DC 11, `+3` to hit with spell attacks). The monk has the following cleric spells prepared:
