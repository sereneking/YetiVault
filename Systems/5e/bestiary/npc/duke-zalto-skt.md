...
```ad-statblock
title: Duke Zalto
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Duke%20Zalto.webp#token)
...
***Special Equipment.*** Zalto wears a [ring of lightning resistance](/Systems/5e/items/ring-of-lightning-resistance.md).

***Tackle.*** When Zalto enters any enemy's space for the first time on a turn, the enemy must succeed on a DC 19 Strength saving throw or be knocked [prone](/Systems/5e/rules/conditions.md#prone).
