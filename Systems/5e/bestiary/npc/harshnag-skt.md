...
```ad-statblock
title: Harshnag
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Harshnag.webp#token)
*Huge giant, Chaotic Good*

- **Armor Class** 21 ([+3 plate armor](/Systems/5e/items/3-armor.md))
