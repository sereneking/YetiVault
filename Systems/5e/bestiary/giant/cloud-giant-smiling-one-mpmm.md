...
***Control Weather (8th-level Spell).*** The giant can cast the [control weather](/Systems/5e/spells/control-weather.md) spell, requiring no material components and using Charisma as the spellcasting ability.
...
**At will**: [detect magic](/Systems/5e/spells/detect-magic.md), [fog cloud](/Systems/5e/spells/fog-cloud.md), [light](/Systems/5e/spells/light.md), [minor illusion](/Systems/5e/spells/minor-illusion.md)

**1/day each**: [gaseous form](/Systems/5e/spells/gaseous-form.md), [major image](/Systems/5e/spells/major-image.md)

**3/day each**: [invisibility](/Systems/5e/spells/invisibility.md), [silent image](/Systems/5e/spells/silent-image.md), [suggestion](/Systems/5e/spells/suggestion.md), [tongues](/Systems/5e/spells/tongues.md)
