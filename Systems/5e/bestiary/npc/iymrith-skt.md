...
```ad-statblock
title: Iymrith
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/SKT/Iymrith.webp#token)
...
**1/day each**: [detect magic](/Systems/5e/spells/detect-magic.md), [dispel magic](/Systems/5e/spells/dispel-magic.md), [ice storm](/Systems/5e/spells/ice-storm.md), [stone shape](/Systems/5e/spells/stone-shape.md), [teleport](/Systems/5e/spells/teleport.md)

When she casts her [stone shape](/Systems/5e/spells/stone-shape.md) spell, Iymrith can shape the targeted stone into a living [gargoyle](/Systems/5e/bestiary/elemental/gargoyle.md) instead of altering the stone as described in the spell's description. This transformation is permanent and can't be reversed or dispelled.
...
***Change Shape.*** Iymrith magically polymorphs into a female [storm giant](/Systems/5e/bestiary/giant/storm-giant.md) or back into her true form. She reverts to her true form if she dies. Any equipment she is wearing or carrying is absorbed or borne by the new form (Iymrith's choice).
...
***Detect.*** Iymrith makes a Wisdom ([Perception](/Systems/5e/rules/skills.md#Perception)) check.

***Tail Attack.*** Iymrith makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Iymrith beats her wings. Each creature within 15 feet of Iymrith must succeed on a DC 24 Dexterity saving throw or take 16 (`2d6 + 9`) bludgeoning damage and be knocked [prone](/Systems/5e/rules/conditions.md#prone). Iymrith can then fly up to half her flying speed.

![Blue Dragon](/Systems/5e/bestiary/legendary-group/blue-dragon.md)
```
^statblock