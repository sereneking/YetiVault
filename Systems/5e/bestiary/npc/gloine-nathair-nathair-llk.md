...
```ad-statblock
title: Gloine Nathair-Nathair
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/LLK/Gloine%20Nathair-Nathair.webp#token)
...
***Multiattack.*** Gloine makes either three melee attacks—one with its snake hair and two with its shortsword—or two ranged attacks with its longbow.
