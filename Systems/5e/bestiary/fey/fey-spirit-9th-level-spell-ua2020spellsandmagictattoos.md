...
![](https://raw.githubusercontent.com/TheGiddyLimit/unearthed-arcana/master/_img/UA2020SpellsAndMagicTattoos/tokens/Fey%20Spirit.webp#token)
*Small fey, Chaotic Good*

- **Armor Class** 20 (natural armor)
- **Hit Points** 104 (equal the fey's Constitution modifier + your spellcasting ability modifier + ten times the spell's level)
- **Speed** 40 ft.
...
***Shortsword.*** *Melee Weapon Attack:* `3 + summonSpellLevel` to hit, reach 5 ft., one target. *Hit:* `1d6 + 3 + summonSpellLevel` piercing damage `+ 1d6` force damage.
```
^statblock