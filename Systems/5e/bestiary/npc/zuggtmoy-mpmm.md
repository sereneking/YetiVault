...
**At will**: [detect magic](/Systems/5e/spells/detect-magic.md), [locate animals or plants](/Systems/5e/spells/locate-animals-or-plants.md)

**1/day each**: [etherealness](/Systems/5e/spells/etherealness.md), [teleport](/Systems/5e/spells/teleport.md)

**3/day each**: [dispel magic](/Systems/5e/spells/dispel-magic.md), [entangle](/Systems/5e/spells/entangle.md), [plant growth](/Systems/5e/spells/plant-growth.md)
...
***Protective Thrall.*** When Zuggtmoy is hit by an attack roll, one creature within 10 feet of her that is [charmed](/Systems/5e/rules/conditions.md#charmed) by her is hit by the attack instead.

## Legendary Actions

***Attack.*** Zuggtmoy makes one Pseudopod attack.

***Exert Will.*** One creature [charmed](/Systems/5e/rules/conditions.md#charmed) by Zuggtmoy that she can see must use its reaction, if a available, to move up to its speed as she directs or to make one weapon attack against a target that she designates.

![Zuggtmoy](/Systems/5e/bestiary/legendary-group/zuggtmoy-mpmm.md)
```
^statblock