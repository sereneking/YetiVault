...
aliases: ["Demonlord of Ashmouth"]
---
# Demonlord of Ashmouth
*Source: Plane Shift: Innistrad p. 37*  

```ad-statblock
title: Demonlord of Ashmouth
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/PSI/Demonlord%20of%20Ashmouth.webp#token)
...
***Multiattack.*** The demon makes three melee attacks: two with its battleaxe and one with its tail. It can use Hurl Flame in place of any melee attack.

***Battleaxe.*** *Melee Weapon Attack:* `+10` to hit, reach 10 ft., one target. *Hit:* 15 (`2d8 + 6`) slashing damage, or 17 (`2d10 + 6`) slashing damage if used with two hands.
