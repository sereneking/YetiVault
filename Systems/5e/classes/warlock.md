...
> 
> | Level | Cantrips Known | Spells Known | Spell Slots | Slot Level | [Invocations Known](/Systems/5e/optional-features/list-eldritch-invocation.md) |
> |-------|----------------|--------------|-------------|------------|--------------------------------------------------------------------------------|
> | 1st | 2 | 2 | 1 | 1st | ⏤ |
> | 2nd | 2 | 3 | 2 | 1st | 2 |
> | 3rd | 2 | 4 | 2 | 2nd | 2 |
...
- (a) a [scholar's pack](/Systems/5e/items/scholars-pack.md) or (b) a [dungeoneer's pack](/Systems/5e/items/dungeoneers-pack.md)  
- [Leather armor](/Systems/5e/items/leather-armor.md), any simple weapon, and two [daggers](/Systems/5e/items/dagger.md)  
...
For example, when you are 5th level, you have two 3rd-level spell slots. To cast the 1st-level spell [witch bolt](/Systems/5e/spells/witch-bolt.md), you must spend one of those slots, and you cast it as a 3rd-level spell.
...
You can use an [arcane focus](/Systems/5e/items/arcane-focus.md) as a spellcasting focus for your warlock spells.
...
At 2nd level, you gain two eldritch invocations of your choice. A list of the available options can be found on the [Optional Features](/Systems/5e/optional-features/list-eldritch-invocation.md) page. When you gain certain warlock levels, you gain additional invocations of your choice, as shown in the Invocations Known column of the Warlock table.
...
- [Pact of the Chain](/Systems/5e/optional-features/pact-of-the-chain.md)  
- [Pact of the Blade](/Systems/5e/optional-features/pact-of-the-blade.md)  
- [Pact of the Tome](/Systems/5e/optional-features/pact-of-the-tome.md)  
...
*4th-level warlock [optional class features](/Systems/5e/rules/variant-rules/optional-class-features-tce.md)*
...
> ![Eldritch Invocation](/Systems/5e/optional-features/list-eldritch-invocation.md#Eldritch%20Invocation)
^list-eldritch-invocation

> [!example]- Pact Boon
> ![Pact Boon](/Systems/5e/optional-features/list-pact-boon.md#Pact%20Boon)
^list-pact-boon