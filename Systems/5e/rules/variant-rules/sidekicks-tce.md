...
When you create a sidekick, you choose the class it will have for the rest of its career: [Expert](/Systems/5e/classes/expert-sidekick-tce.md), [Spellcaster](/Systems/5e/classes/spellcaster-sidekick-tce.md), or [Warrior](/Systems/5e/classes/warrior-sidekick-tce.md). If a sidekick class contains a choice, you may make the choice or let the players make it.
...
If the sidekick drops to 0 hit points and isn't killed outright, it falls [unconscious](/Systems/5e/rules/conditions.md#unconscious) and subsequently makes death saving throws, just like a player character.
