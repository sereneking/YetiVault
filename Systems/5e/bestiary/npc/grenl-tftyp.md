...
```ad-statblock
title: Grenl
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/TftYP/Grenl.webp#token)
...
**Cantrips (at will)**: [poison spray](/Systems/5e/spells/poison-spray.md), [thaumaturgy](/Systems/5e/spells/thaumaturgy.md)

**1st level (2 slots)**: [bane](/Systems/5e/spells/bane.md), [inflict wounds](/Systems/5e/spells/inflict-wounds.md)
