...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/ToB1-2023/Elvish%20Veteran%20Archer.webp#token)
...
***Beast Hunter.*** The elvish veteran archer has advantage on Wisdom ([Survival](/Systems/5e/rules/skills.md#Survival)) checks to track Beasts and on Intelligence ([Nature](/Systems/5e/rules/skills.md#Nature)) checks to recall information about Beasts.

***Fey Ancestry.*** The elvish veteran archer has advantage on saving throws against being [charmed](/Systems/5e/rules/conditions.md#charmed), and magic can't put the archer to sleep.

***Keen Hearing and Sight.*** The elvish veteran archer has advantage on Wisdom ([Perception](/Systems/5e/rules/skills.md#Perception)) checks that rely on hearing or sight.
