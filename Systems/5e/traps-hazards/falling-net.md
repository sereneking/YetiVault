...
When the trap is triggered, the net is released, covering a 10-foot-square area. Those in the area are trapped under the net and [restrained](/Systems/5e/rules/conditions.md#restrained), and those that fail a DC 10 Strength saving throw are also knocked [prone](/Systems/5e/rules/conditions.md#prone).
