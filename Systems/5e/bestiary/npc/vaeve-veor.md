...
```ad-statblock
title: Vaeve
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/bestiary/tokens/VEoR/Vaeve.webp#token)
...
***Fey Ancestry.*** Vaeve has advantage on saving throws against being [charmed](/Systems/5e/rules/conditions.md#charmed), and magic can't put Vaeve to sleep.

***Sunlight Sensitivity.*** While in sunlight, Vaeve has disadvantage on attack rolls, as well as on Wisdom ([Perception](/Systems/5e/rules/skills.md#Perception)) checks that rely on sight.
